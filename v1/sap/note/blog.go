...
import (
	"github.com/SUSE/saptune/v1/sap"
	"github.com/SUSE/saptune/v1/sap/param"
	"github.com/SUSE/saptune/v1/system"
	"github.com/SUSE/saptune/v1/txtparser"
	"path"
)
...
func (st SUSESysOptimisation) Name() string {
	...
	return "SLES 12 OS Tuning & Optimization Guide – Part 1 (deprecated and not SAP approved)"
}
...
func (st SUSENetCPUOptimisation) Name() string {
	// Do not mention SLES 11 here
	return "SLES 12: Network, CPU Tuning and Optimization – Part 2 (deprecated and not SAP approved)"
}
