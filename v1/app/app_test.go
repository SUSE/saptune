...
import (
	"fmt"
	"github.com/SUSE/saptune/v1/sap/note"
	"github.com/SUSE/saptune/v1/sap/param"
	"github.com/SUSE/saptune/v1/sap/solution"
	"io/ioutil"
	"os"
	"path"
	"reflect"
...
var OSPackageInGOPATH = path.Join(os.Getenv("GOPATH"), "/src/github.com/SUSE/saptune/v1/ospackage/")
